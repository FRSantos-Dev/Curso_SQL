...
Hoje há um funcionário de vendas que tem uma tabela do Ecele para guardar esses registros, mas as buscas estão ficando complexas.
Decidiu-se então cirar um banco de dados separad para esse funcionário.

Após a criação da tabela, deveremos entregar algumas queries prontas para que sejam enviadas
para o programador. As queries são as seguintes:

1-Trazer todos os dados.
2-Trazer o nome do livro e o nome da editora.
3-Trazer p nome do livro e a UF dos livros publicados por autores do sexo masculino.
